...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StaffContact'
        db.create_table('distribution_staffcontact', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('food_network', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contacts', to=orm['distribution.FoodNetwork'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('role', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=4, max_length='1')),
            ...
            ('login_user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='staff_contact', unique=True, null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('distribution', ['StaffContact'])

        # Deleting field 'FoodNetwork.billing_address'
        db.delete_column('distribution_foodnetwork', 'billing_address')

        # Deleting field 'FoodNetwork.billing_contact'
        db.delete_column('distribution_foodnetwork', 'billing_contact')

        # Deleting field 'FoodNetwork.billing_email_address'
        db.delete_column('distribution_foodnetwork', 'billing_email_address')

        # Deleting field 'FoodNetwork.billing_phone'
        db.delete_column('distribution_foodnetwork', 'billing_phone')

        # Deleting field 'Party.contact'
        db.delete_column('distribution_party', 'contact')

        # Deleting field 'Party.cell'
        db.delete_column('distribution_party', 'cell')


    def backwards(self, orm):
        
        # Deleting model 'StaffContact'
        db.delete_table('distribution_staffcontact')

        # Adding field 'FoodNetwork.billing_address'
        db.add_column('distribution_foodnetwork', 'billing_address', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'FoodNetwork.billing_contact'
        db.add_column('distribution_foodnetwork', 'billing_contact', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'FoodNetwork.billing_email_address'
        db.add_column('distribution_foodnetwork', 'billing_email_address', self.gf('django.db.models.fields.EmailField')(max_length=96, null=True, blank=True), keep_default=False)

        # Adding field 'FoodNetwork.billing_phone'
        db.add_column('distribution_foodnetwork', 'billing_phone', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'Party.contact'
        db.add_column('distribution_party', 'contact', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'Party.cell'
        db.add_column('distribution_party', 'cell', self.gf('django.contrib.localflavor.us.models.PhoneNumberField')(default='', max_length=20, blank=True), keep_default=False)
