...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Producer.philosophy'
        db.add_column('distribution_producer', 'philosophy', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Party.website'
        db.add_column('distribution_party', 'website', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Producer.philosophy'
        db.delete_column('distribution_producer', 'philosophy')

        # Deleting field 'Party.website'
        db.delete_column('distribution_party', 'website')
