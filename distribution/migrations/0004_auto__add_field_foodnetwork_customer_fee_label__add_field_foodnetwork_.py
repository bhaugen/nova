...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FoodNetwork.customer_fee_label'
        db.add_column('distribution_foodnetwork', 'customer_fee_label', self.gf('django.db.models.fields.CharField')(default='Delivery Cost', max_length=64), keep_default=False)

        # Adding field 'FoodNetwork.producer_fee_label'
        db.add_column('distribution_foodnetwork', 'producer_fee_label', self.gf('django.db.models.fields.CharField')(default='Marketing Cost', max_length=64), keep_default=False)

        # Changing field 'FoodNetwork.producer_fee'
        db.alter_column('distribution_foodnetwork', 'producer_fee', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

        # Changing field 'FoodNetwork.customer_fee'
        db.alter_column('distribution_foodnetwork', 'customer_fee', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

        # Changing field 'OrderItem.fee'
        db.alter_column('distribution_orderitem', 'fee', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))


    def backwards(self, orm):
        
        # Deleting field 'FoodNetwork.customer_fee_label'
        db.delete_column('distribution_foodnetwork', 'customer_fee_label')

        # Deleting field 'FoodNetwork.producer_fee_label'
        db.delete_column('distribution_foodnetwork', 'producer_fee_label')

        # Changing field 'FoodNetwork.producer_fee'
        db.alter_column('distribution_foodnetwork', 'producer_fee', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

        # Changing field 'FoodNetwork.customer_fee'
        db.alter_column('distribution_foodnetwork', 'customer_fee', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

        # Changing field 'OrderItem.fee'
        db.alter_column('distribution_orderitem', 'fee', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))
