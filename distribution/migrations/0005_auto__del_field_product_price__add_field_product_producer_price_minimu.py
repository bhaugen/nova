...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #db.delete_column('distribution_product', 'price')

        # Renaming field 'Product.price'
        db.rename_column('distribution_product', 'price', 'selling_price')

        # Adding field 'Product.producer_price_minimum'
        db.add_column('distribution_product', 'producer_price_minimum', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'Product.producer_price_maximum'
        db.add_column('distribution_product', 'producer_price_maximum', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'Product.producer_price'
        db.add_column('distribution_product', 'producer_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'Product.selling_price'
        #db.add_column('distribution_product', 'selling_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Product.price'
        #db.add_column('distribution_product', 'price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)

        # Renaming field 'Product.price'
        db.rename_column('distribution_product', 'selling_price', 'price')

        # Deleting field 'Product.producer_price_minimum'
        db.delete_column('distribution_product', 'producer_price_minimum')

        # Deleting field 'Product.producer_price_maximum'
        db.delete_column('distribution_product', 'producer_price_maximum')

        # Deleting field 'Product.producer_price'
        db.delete_column('distribution_product', 'producer_price')

        # Deleting field 'Product.selling_price'
        #db.delete_column('distribution_product', 'selling_price')
