...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProducerProduct.default_quantity'
        #db.delete_column('distribution_producerproduct', 'default_quantity')

        # Renaming field 'ProducerProduct.default_quantity'
        db.rename_column('distribution_producerproduct', 'default_quantity', 'qty_per_year')

        # Adding field 'ProducerProduct.producer_price'
        db.add_column('distribution_producerproduct', 'producer_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'ProducerProduct.price_change_delivery_date'
        db.add_column('distribution_producerproduct', 'price_change_delivery_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'ProducerProduct.price_changed_by'
        db.add_column('distribution_producerproduct', 'price_changed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='producer_products_changed', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'ProducerProduct.producer_fee'
        db.add_column('distribution_producerproduct', 'producer_fee', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=4, decimal_places=2), keep_default=False)

        # Adding field 'ProducerProduct.qty_per_year'
        #db.add_column('distribution_producerproduct', 'qty_per_year', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ProducerProduct.default_quantity'
        #db.add_column('distribution_producerproduct', 'default_quantity', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)

        # Renaming field 'ProducerProduct.default_quantity'
        db.rename_column('distribution_producerproduct', 'qty_per_year', 'default_quantity')

        # Deleting field 'ProducerProduct.producer_price'
        db.delete_column('distribution_producerproduct', 'producer_price')

        # Deleting field 'ProducerProduct.price_change_delivery_date'
        db.delete_column('distribution_producerproduct', 'price_change_delivery_date')

        # Deleting field 'ProducerProduct.price_changed_by'
        db.delete_column('distribution_producerproduct', 'price_changed_by_id')

        # Deleting field 'ProducerProduct.producer_fee'
        db.delete_column('distribution_producerproduct', 'producer_fee')

        # Deleting field 'ProducerProduct.qty_per_year'
        #db.delete_column('distribution_producerproduct', 'qty_per_year')
    ...
    models = {
        ...
        'distribution.producerproduct': {
            ...
            'planned': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'price_change_delivery_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
