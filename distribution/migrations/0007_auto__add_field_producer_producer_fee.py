...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Producer.producer_fee'
        db.add_column('distribution_producer', 'producer_fee', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=4, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Producer.producer_fee'
        db.delete_column('distribution_producer', 'producer_fee')
