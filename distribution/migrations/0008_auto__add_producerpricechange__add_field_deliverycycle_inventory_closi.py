...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProducerPriceChange'
        db.create_table('distribution_producerpricechange', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('producer_product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='price_changes', to=orm['distribution.ProducerProduct'])),
            ('producer_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2)),
            ('price_change_delivery_date', self.gf('django.db.models.fields.DateField')()),
            ('when_changed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('changed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='producer_prices_changed', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('distribution', ['ProducerPriceChange'])

        # Adding field 'DeliveryCycle.inventory_closing_day'
        db.add_column('distribution_deliverycycle', 'inventory_closing_day', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, max_length='1'), keep_default=False)

        # Adding field 'DeliveryCycle.inventory_closing_time'
        db.add_column('distribution_deliverycycle', 'inventory_closing_time', self.gf('django.db.models.fields.TimeField')(default=datetime.time(12, 0)), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ProducerPriceChange'
        db.delete_table('distribution_producerpricechange')

        # Deleting field 'DeliveryCycle.inventory_closing_day'
        db.delete_column('distribution_deliverycycle', 'inventory_closing_day')

        # Deleting field 'DeliveryCycle.inventory_closing_time'
        db.delete_column('distribution_deliverycycle', 'inventory_closing_time')

        # Changing field 'ProducerProduct.price_change_delivery_date'
        db.alter_column('distribution_producerproduct', 'price_change_delivery_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'distribution.producerpricechange': {
            'Meta': {'object_name': 'ProducerPriceChange'},
        ...
        'distribution.producerproduct': {
            ...
            'planned': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'price_change_delivery_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
