...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.producer'
        db.add_column('distribution_orderitem', 'producer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='order_items', null=True, to=orm['distribution.Producer']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.producer'
        db.delete_column('distribution_orderitem', 'producer_id')
