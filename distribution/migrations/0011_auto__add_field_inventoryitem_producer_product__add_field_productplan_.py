...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InventoryItem.producer_product'
        db.add_column('distribution_inventoryitem', 'producer_product', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='inventory_items', null=True, to=orm['distribution.ProducerProduct']), keep_default=False)

        # Adding field 'ProductPlan.producer_product'
        db.add_column('distribution_productplan', 'producer_product', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='product_plans', null=True, to=orm['distribution.ProducerProduct']), keep_default=False)

        # Adding field 'OrderItem.producer_product'
        db.add_column('distribution_orderitem', 'producer_product', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='order_items', null=True, to=orm['distribution.ProducerProduct']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InventoryItem.producer_product'
        db.delete_column('distribution_inventoryitem', 'producer_product_id')

        # Deleting field 'ProductPlan.producer_product'
        db.delete_column('distribution_productplan', 'producer_product_id')

        # Deleting field 'OrderItem.producer_product'
        db.delete_column('distribution_orderitem', 'producer_product_id')
