...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProducerProduct.markup_percent'
        db.add_column('distribution_producerproduct', 'markup_percent', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=4, decimal_places=2), keep_default=False)

        # Adding field 'ProducerProduct.selling_price'
        db.add_column('distribution_producerproduct', 'selling_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'ProducerPriceChange.markup_percent'
        db.add_column('distribution_producerpricechange', 'markup_percent', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=4, decimal_places=2), keep_default=False)

        # Adding field 'ProducerPriceChange.selling_price'
        db.add_column('distribution_producerpricechange', 'selling_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProducerProduct.markup_percent'
        db.delete_column('distribution_producerproduct', 'markup_percent')

        # Deleting field 'ProducerProduct.selling_price'
        db.delete_column('distribution_producerproduct', 'selling_price')

        # Deleting field 'ProducerPriceChange.markup_percent'
        db.delete_column('distribution_producerpricechange', 'markup_percent')

        # Deleting field 'ProducerPriceChange.selling_price'
        db.delete_column('distribution_producerpricechange', 'selling_price')
