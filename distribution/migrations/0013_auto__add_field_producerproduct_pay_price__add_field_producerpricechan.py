...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProducerProduct.pay_price'
        db.add_column('distribution_producerproduct', 'pay_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'ProducerPriceChange.producer_fee'
        db.add_column('distribution_producerpricechange', 'producer_fee', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=4, decimal_places=2), keep_default=False)

        # Adding field 'ProducerPriceChange.pay_price'
        db.add_column('distribution_producerpricechange', 'pay_price', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=8, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProducerProduct.pay_price'
        db.delete_column('distribution_producerproduct', 'pay_price')

        # Deleting field 'ProducerPriceChange.producer_fee'
        db.delete_column('distribution_producerpricechange', 'producer_fee')

        # Deleting field 'ProducerPriceChange.pay_price'
        db.delete_column('distribution_producerpricechange', 'pay_price')
