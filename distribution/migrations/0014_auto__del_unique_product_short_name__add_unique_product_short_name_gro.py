...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Product', fields ['short_name']
        db.delete_unique('distribution_product', ['short_name'])

        # Adding unique constraint on 'Product', fields ['short_name', 'growing_method']
        db.create_unique('distribution_product', ['short_name', 'growing_method'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Product', fields ['short_name', 'growing_method']
        db.delete_unique('distribution_product', ['short_name', 'growing_method'])

        # Adding unique constraint on 'Product', fields ['short_name']
        db.create_unique('distribution_product', ['short_name'])
