...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Party.background_color'
        db.add_column('distribution_party', 'background_color', self.gf('django.db.models.fields.CharField')(default='White', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Party.background_color'
        db.delete_column('distribution_party', 'background_color')
