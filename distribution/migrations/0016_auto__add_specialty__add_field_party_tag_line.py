...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('distribution_specialty', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('distribution', ['Specialty'])

        # Adding M2M table for field specialties on 'Producer'
        db.create_table('distribution_producer_specialties', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('producer', models.ForeignKey(orm['distribution.producer'], null=False)),
            ('specialty', models.ForeignKey(orm['distribution.specialty'], null=False))
        ))
        db.create_unique('distribution_producer_specialties', ['producer_id', 'specialty_id'])

        # Adding field 'Party.tag_line'
        db.add_column('distribution_party', 'tag_line', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Specialty'
        db.delete_table('distribution_specialty')

        # Removing M2M table for field specialties on 'Producer'
        db.delete_table('distribution_producer_specialties')

        # Deleting field 'Party.tag_line'
        db.delete_column('distribution_party', 'tag_line')
