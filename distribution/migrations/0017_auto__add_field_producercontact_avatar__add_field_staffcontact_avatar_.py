...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProducerContact.avatar'
        db.add_column('distribution_producercontact', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'StaffContact.avatar'
        db.add_column('distribution_staffcontact', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Party.logo'
        db.add_column('distribution_party', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'CustomerContact.avatar'
        db.add_column('distribution_customercontact', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProducerContact.avatar'
        db.delete_column('distribution_producercontact', 'avatar')

        # Deleting field 'StaffContact.avatar'
        db.delete_column('distribution_staffcontact', 'avatar')

        # Deleting field 'Party.logo'
        db.delete_column('distribution_party', 'logo')

        # Deleting field 'CustomerContact.avatar'
        db.delete_column('distribution_customercontact', 'avatar')
    ...
    models = {
        ...
        'distribution.inventoryitem': {
            ...
            'producer_product': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'inventory_items'", 'null': 'True', 'to': "orm['distribution.ProducerProduct']"}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distribution.Product']"}),
        ...
        'distribution.orderitem': {
            ...
            'producer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'order_items'", 'null': 'True', 'to': "orm['distribution.Producer']"}),
            'producer_product': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'order_items'", 'null': 'True', 'to': "orm['distribution.ProducerProduct']"}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distribution.Product']"}),
        ...
        'distribution.party': {
            ...
            'background_color': ('django.db.models.fields.CharField', [], {'default': "'White'", 'max_length': '32'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True'}),
            ...
            'tag_line': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        'distribution.producer': {
            ...
            'producer_fee': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '4', 'decimal_places': '2'}),
            'specialties': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'producers'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['distribution.Specialty']"})
        },
        ...
        'distribution.producerpricechange': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'markup_percent': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '4', 'decimal_places': '2'}),
            'pay_price': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '8', 'decimal_places': '2'}),
        ...
        'distribution.product': {
            'Meta': {'ordering': "('short_name',)", 'unique_together': "(('short_name', 'growing_method'),)", 'object_name': 'Product'},
        ...
        'distribution.productplan': {
            ...
            'producer_product': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'product_plans'", 'null': 'True', 'to': "orm['distribution.ProducerProduct']"}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['distribution.Product']"}),
        ...
        'distribution.specialty': {
            'Meta': {'ordering': "('name',)", 'object_name': 'Specialty'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
